...
// TimeDependentGraph and JTSGraph. We do NOT redefine them here.
...
public:
    ...
    // [FACTORY] Builds a JTSGraph from an Intermediate::Data representation.
    ...
    // [FACTORY] Loads a JTSGraph from a binary file on disk.
